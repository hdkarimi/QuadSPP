...
"",
" usage: qspp [file.rnx] [file.sp3] [option...]",
"",
...
"",
"example: qspp mmmmddd0.rnx aaawwwwd.sp3 -ts yyyy/mm/dd hh:mm:ss -el 20",
"example: qspp mmmmddd0.rnx aaawwwwd.sp3 -sys C -sf 1 -el 10 -gd 30",
};
/* show message --------------------------------------------------------------*/
